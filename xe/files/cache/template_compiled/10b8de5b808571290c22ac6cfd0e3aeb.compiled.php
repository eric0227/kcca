...
<fieldset class="list">
	<?php if($__Context->lang_code_list&&count($__Context->lang_code_list))foreach($__Context->lang_code_list as $__Context->no=>$__Context->val){ ?><form action="" class="item"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment()) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
...
<div class="x_clearfix">
	<?php if($__Context->page_navigation){ ?><form action="./" class="x_pagination x_pull-left" data-search_keyword="<?php echo htmlspecialchars($__Context->search_keyword) ?>" data-page="<?php echo $__Context->page ?>" data-current_lang="<?php echo $__Context->lang_code ?>" ><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
		<ul>
			<li<?php if(!$__Context->page || $__Context->page == 1){ ?> class="x_disabled"<?php } ?>><a href="#" data-page="1" data-search_keyword="<?php echo htmlspecialchars($__Context->search_keyword) ?>">&laquo; <?php echo $__Context->lang->first_page ?></a></li>
			...
			<li<?php if($__Context->page_no == $__Context->page){ ?> class="x_active"<?php } ?>><a  href="#" data-page="<?php echo $__Context->page_no ?>" data-search_keyword="<?php echo htmlspecialchars($__Context->search_keyword) ?>"><?php echo $__Context->page_no ?></a></li>
			<?php } ?>
			...
			<?php } ?>
		<li<?php if($__Context->page == $__Context->page_navigation->last_page){ ?> class="x_disabled"<?php } ?>><a href="#" data-page="<?php echo $__Context->page_navigation->last_page ?>" data-search_keyword="<?php echo htmlspecialchars($__Context->search_keyword) ?>" title="<?php echo $__Context->page_navigation->last_page ?>"><?php echo $__Context->lang->last_page ?> &raquo;</a></li>
		</ul>
	</form><?php } ?>
	<form action="" class="search center x_input-append x_pull-right"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment()) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
...
echo htmlspecialchars($__Context->lang_code_list[1]->value);
}else{;
echo htmlspecialchars($__Context->search_keyword);
} ?>">
