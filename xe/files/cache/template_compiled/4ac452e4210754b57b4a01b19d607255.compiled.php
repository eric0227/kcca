...
<ul class="x_nav x_nav-tabs">
	<li<?php if($__Context->act=='dispModuleAdminContent'){ ?> class="x_active"<?php } ?>>
		<a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispModuleAdminContent') ?>"><?php echo $__Context->lang->installed_modules ?></a>
	</li>
	<li<?php if($__Context->act=='dispModuleAdminCategory'){ ?> class="x_active"<?php } ?>>
		<a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispModuleAdminCategory') ?>"><?php echo $__Context->lang->module_category ?></a>
	</li>
</ul>
