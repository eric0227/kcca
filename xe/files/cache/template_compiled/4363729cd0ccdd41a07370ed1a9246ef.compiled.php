...
<div class="x">
	<div id="header">
		<h1><img src="/kcca/xe/modules/install/tpl/img/xe.gif" width="163" height="26" alt="Xpress Engine" /></h1>
		<em>Version <strong><?php echo __XE_VERSION__ ?></strong> <?php echo $__Context->lang->introduce_title ?></em>
	</div>
