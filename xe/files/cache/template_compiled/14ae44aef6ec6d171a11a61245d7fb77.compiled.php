...
<!--#Meta:layouts/default/default.layout.ie78.css--><?php $__tmp=array('layouts/default/default.layout.ie78.css','','lt IE 9','');Context::loadFile($__tmp,'','','');unset($__tmp); ?>
<!--#Meta:layouts/default/default.layout.ie7.css--><?php $__tmp=array('layouts/default/default.layout.ie7.css','','IE 7','');Context::loadFile($__tmp,'','','');unset($__tmp); ?>
	...
	<header class="header">
		<h1>
			<a href="<?php echo geturl('') ?>" id="siteTitle">
				<?php if(!Context::getSiteTitle() && !$__Context->layout_info->LOGO_IMG && !$__Context->layout_info->LOGO_TEXT){ ?><img src="/kcca/xe/layouts/default/siteTitle.png" alt="XpressEngine"><?php } ?>
...
echo $__Context->layout_info->LOGO_TEXT;
		...
		<div class="side">
			...
			<!-- /ACCOUNT -->
			<!-- SEARCH -->
			<form action="<?php echo getUrl() ?>" method="get" class="search"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment()) ?>" />
...
if($__Context->layout_info->LAYOUT_TYPE=='SUB_PAGE'){ ?> class="visual sub"<?php } ?>>
		<div class="list">
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispAdminConfigGeneral') ?>" class="item i1">
				<img src="/kcca/xe/layouts/default/visual.main.1.jpg" alt="" />
			...
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispMenuAdminSiteMap') ?>" class="item i2">
				<img src="/kcca/xe/layouts/default/visual.main.2.jpg" alt="" />
			...
			<?php if($__Context->layout_info->LAYOUT_TYPE=='MAIN_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispLayoutAdminInstanceList','layout','default') ?>" class="item i3">
				<img src="/kcca/xe/layouts/default/visual.main.3.jpg" alt="" />
			...
			<?php if($__Context->layout_info->LAYOUT_TYPE=='SUB_PAGE'){ ?><a href="<?php echo geturl('','module','admin','act','dispLayoutAdminInstanceList','layout','default') ?>" class="item i1">
				<img src="/kcca/xe/layouts/default/visual.sub.jpg" alt="" />
