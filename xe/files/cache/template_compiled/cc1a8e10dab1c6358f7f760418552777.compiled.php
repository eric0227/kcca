...
echo $__Context->author->name;
				...
				<td><input type="checkbox" name="pc_on[]" title="PC" value="<?php echo htmlspecialchars($__Context->addon->addon_name) ?>"<?php if($__Context->addon->activated){ ?> checked="checked"<?php } ?> /></td>
				<td><input type="checkbox" name="mobile_on[]" title="Mobile" value="<?php echo htmlspecialchars($__Context->addon->addon_name) ?>"<?php if($__Context->addon->mactivated){ ?> checked="checked"<?php } ?> /></td>
