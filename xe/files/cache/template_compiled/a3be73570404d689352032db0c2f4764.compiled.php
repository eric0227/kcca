...
<section class="section">
	...
	<form action="./" method="get" onSubmit="return false" id="fo" class="x_form-horizontal"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment()) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
		...
		<div class="x_control-group">
			...
			<div class="x_controls">
				<label for="align_normal">
					...
					<img src="/kcca/xe/modules/editor/components/image_link/tpl/images/align_normal.gif" alt="<?php echo $__Context->lang->image_align_normal ?>" />
					<?php echo $__Context->lang->image_align_normal ?>
				</label>
				<label for="align_left">
					<input type="radio" name="align" value="left" id="align_left" />
					<img src="/kcca/xe/modules/editor/components/image_link/tpl/images/align_left.gif" alt="<?php echo $__Context->lang->image_align_left ?>" />
					<?php echo $__Context->lang->image_align_left ?>
				</label>
				<label for="align_middle">
					<input type="radio" name="align" value="middle" id="align_middle" />
					<img src="/kcca/xe/modules/editor/components/image_link/tpl/images/align_middle.gif" alt="<?php echo $__Context->lang->image_align_middle ?>" />
					<?php echo $__Context->lang->image_align_middle ?>
				</label>
				<label for="align_right">
					<input type="radio" name="align" value="right" id="align_right" />
					<img src="/kcca/xe/modules/editor/components/image_link/tpl/images/align_right.gif" alt="<?php echo $__Context->lang->image_align_right ?>" />
