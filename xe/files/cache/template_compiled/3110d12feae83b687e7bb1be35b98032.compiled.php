...
<div class="x_page-header">
	<h1>
		...
		<?php if($__Context->layout_info){ ?><span class="path" title="<?php echo $__Context->layout_info->layout ?>">&gt; <?php echo $__Context->layout_info->title ?> v<?php echo $__Context->layout_info->version ?></span><?php } ?>
		<?php if($__Context->selected_layout){ ?><span class="path" title="<?php echo $__Context->selected_layout->layout ?>">&gt; <?php echo $__Context->selected_layout->title ?> v<?php echo $__Context->selected_layout->version ?></span><?php } ?>
		<?php if($__Context->selected_layout){ ?><span class="path">&gt; <?php echo $__Context->selected_layout->layout_title ?></span><?php } ?>
	</h1>
</div>
	...
	<div class="x_modal-body">
		<ol>
			<li>
				...
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/01.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/01_en.png" alt="" /><?php } ?>
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[3] ?></p>
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/02.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/02_en.png" alt="" /><?php } ?>
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[4] ?></p>
				<img src="/kcca/xe/modules/layout/tpl/faceoff_migration/03.png" alt="" />
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[5] ?></p>
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/04.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/04_en.png" alt="" /><?php } ?>
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[6] ?></p>
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/05.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/kcca/xe/modules/layout/tpl/faceoff_migration/05_en.png" alt="" /><?php } ?>
			</li>
		</ol>
	</div>
