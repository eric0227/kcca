...
${'site_srl210_argument'} = new ConditionArgument('site_srl', $args->site_srl, 'equal');
${'site_srl210_argument'}->checkNotNull();
${'site_srl210_argument'}->createConditionValue();
if(!${'site_srl210_argument'}->isValid()) return ${'site_srl210_argument'}->getErrorMessage();
if(${'site_srl210_argument'} !== null) ${'site_srl210_argument'}->setColumnType('number');
...
new ConditionGroup(array(
new ConditionWithArgument('`sites`.`site_srl`',$site_srl210_argument,"equal")))
));
