...
$lang->about_importer='다른 프로그램의 데이터를 XML 형식으로 변환 후 업로드하면 XE로 이전할 수 있습니다. <a href="http://svn.xpressengine.com/zeroboard_xe/migration_tools/" target="_blank">XML Exporter</a>를 이용하면 XML파일로 변환할 수 있습니다.';
