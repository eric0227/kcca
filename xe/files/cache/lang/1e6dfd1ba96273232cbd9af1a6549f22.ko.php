...
$lang->edit->uploading_info='%s MB까지 업로드할 수 있습니다';
$lang->edit->uploaded_image='사용자 업로드 이미지';
$lang->edit->image_width='이미지 너비';
$lang->edit->resize='줄이기';
$lang->edit->resize_info='지정한 크기의 사본을 만들며 원본은 유지됩니다';
...
$lang->edit->file_uploadinfo='개당 %sMB, 모두 합쳐 %sMB까지 업로드가 가능합니다';
...
$lang->edit->help_first_dd_1='도구모음 버튼을 클릭함으로써 새 단락 쓰기를 시작할 수 있습니다. 도구모음 버튼에는 배치된 순서대로 왼쪽으로부터 1~9까지 단축키가 할당되어 있습니다. 숫자키 \'0\' 또는 ESC키 바로 아래 위치한 [`] 그레이브(grave) 키를 누르면 숨겨진 도구모음 버튼을 보거나 토글(toggle)할 수 있습니다.';
...
$lang->edit->image_align='정렬 방법';
$lang->edit->align_normal='한 문단을 차지';
$lang->edit->align_left='글의 왼쪽으로';
$lang->edit->align_center='가운데';
$lang->edit->align_right='글의 우측으로';
